...
export default async function SummaryPage({ searchParams }: PageProps) {
  ...
  return (
    <div className="bg-[#F8FAFC] min-h-screen pb-24 lg:pb-0 lg:pl-60">
      ...
      <div className="max-w-lg mx-auto lg:max-w-5xl lg:px-4 pt-3">
        {/* デスクトップ: 左（バナー＋テーブル＋ボタン）/ 右（チェックリスト） */}
        <div className="lg:grid lg:grid-cols-2 lg:gap-5 lg:items-start space-y-3 lg:space-y-0">
          ...
          <div className="space-y-3">
            {/* 申告要否バナー */}
            {needsFiling ? (
              <div className="mx-4 lg:mx-0 mt-4 bg-red-50 border border-red-200 rounded-2xl px-4 py-3 flex items-center gap-3">
              ...
              <div className="mx-4 lg:mx-0 mt-4 bg-emerald-50 border border-emerald-200 rounded-2xl px-4 py-3 flex items-center gap-3">
            ...
            {/* 収支サマリーテーブル */}
            <div className="mx-4 lg:mx-0 mt-3 bg-white rounded-2xl shadow-sm overflow-hidden">
            ...
            {/* ボタン */}
            <div className="mx-4 lg:mx-0 space-y-2.5 pb-6">
              <a
